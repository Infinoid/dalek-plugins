...
is($$output[1]{text}, 'TT #694: http://trac.parrot.org/parrot/ticket/694', 'link line');
is($$output[2]{text}, 'TT #695 created by urkle++: subtest 3 in t/dynoplibs/myops.t segfaults on darwin' , 'log line');
is($$output[3]{text}, 'TT #695: http://trac.parrot.org/parrot/ticket/695' , 'link line');
BEGIN { $tests += 7 };
