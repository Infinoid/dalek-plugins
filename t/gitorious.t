...
is($$output[0]{text}, 'parrot-plumage: 7c709f9 | darbelo++ | metadata/decnum-dynpmcs.json:' , "karma line");
...
is($$output[0]{net} , 'magnet'  , "line to magnet/#parrot");
is($$output[0]{chan}, '#parrot' , "line to magnet/#parrot");
is($$output[0]{text}, 'parrot-plumage: 6d885b2 | japhb++ | Glue.pir:' , "karma line");
...
is($$output[3]{text}, 'parrot-plumage: d3858b4 | japhb++ | plumage.nqp:' , "karma line");
...
$xml_footer = << '__XML__' . $xml_footer;
  <entry>
    <id>tag:gitorious.org,2005:Event/4563909</id>
    <published>2009-11-03T01:07:19Z</published>
    <updated>2009-11-03T01:07:19Z</updated>
    <link rel="alternate" type="text/html" href="http://gitorious.org/parrot-plumage"/>
    <title>pmichaud pushed 1 commit  to parrot-plumage/parrot-plumage:master</title>
    <content type="html">  &lt;p&gt;&lt;a href="/~pmichaud"&gt;pmichaud&lt;/a&gt; &lt;strong&gt;pushed &lt;a href="/parrot-plumage/parrot-plumage/commits/master" class="commit_event_toggler" gts:id="4563909" gts:url="/events/4563909/commits" id="commits_in_event_4563909_toggler"&gt;2 commits&lt;/a&gt;&lt;/strong&gt;  to &lt;a href="/parrot-plumage/parrot-plumage/commits/master"&gt;parrot-plumage/parrot-plumage:master&lt;/a&gt;&lt;/p&gt;
  &lt;p&gt;master changed from d3858b4 to cab5aca&lt;p&gt;
&lt;ul&gt;&lt;li&gt; &lt;a href="/parrot-plumage/parrot-plumage/commit/cab5aca8db5de3f5a2755086de31c569fdd03afc"&gt;cab5aca&lt;/a&gt;: Update t/glue.t, t/sanity.t, t/harness for nqp-rx.&lt;/li&gt;&lt;/ul&gt;</content>
    <author>
      <name>pmichaud</name>
    </author>
  </entry>
...
modules::local::parrot_plumagelog->process_feed($feed);
$output = [output()];
is(scalar @$output, 5, "5 lines of output");
is($$output[0]{net} , 'magnet'  , "line to magnet/#parrot");
is($$output[0]{chan}, '#parrot' , "line to magnet/#parrot");
is($$output[0]{text}, 'parrot-plumage: cab5aca | pmichaud++ | t/ (3 files):' , "karma line");
is($$output[1]{text}, 'parrot-plumage: Update t/glue.t, t/sanity.t, t/harness for nqp-rx.' , "log line");
is($$output[2]{text}, 'parrot-plumage: Both t/glue.t and t/sanity.t run successfully when executed directly' , "log line");
is($$output[3]{text}, 'parrot-plumage: by nqp, for some reason t/harness hangs while running.' , "log line");
is($$output[4]{text}, 'parrot-plumage: review: http://gitorious.org/parrot-plumage/parrot-plumage/commit/cab5aca8db5de3f5a2755086de31c569fdd03afc' , "link line");
BEGIN { $tests += 8 };
